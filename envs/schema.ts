...
export const envSchema = z.object({
  ...
  VITE_SERVICE_MAIN_PROXY: z.string().optional().meta({ description: '主服务代理 URL' }),
  ...
  VITE_SERVICE_CONFIG_URL: z
    ...
    .trim()
    .min(1, '配置服务 URL 不能为空')
    .meta({ description: '配置服务 URL' }),
  VITE_SERVICE_CONFIG_PROXY: z.string().optional().meta({ description: '配置服务代理 URL' }),
